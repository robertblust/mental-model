...
| Engineering leadership | Expert | Led technology as co-founder and CTO of 3AP, then co-founder and Head of Technology at LIKE MAGIC — 3AP scaling to about 70 people, LIKE MAGIC to 25. Set the technology direction and developed the technical leadership; people management sat with the Head of Engineering. Earlier at UBS, set the engineering process and built the SDLC toolchain that the division's engineering teams worked inside. |
