...
| Organization design | Proficient | Shaped the technology organization at 3AP as it scaled to about 70 people including a near-shore team in Serbia, and at LIKE MAGIC as it grew to 25 — its structure and roles rather than its line management. |
...
| Engineering leadership | Expert | Led technology as co-founder and CTO of 3AP, then co-founder and Head of Technology at LIKE MAGIC — 3AP scaling to about 70 people, LIKE MAGIC to 25. Set the technology direction and developed the technical leadership; people management sat with the Head of Engineering, and the authority was architectural — the reference architecture, the technology stack and the approvals every engagement had to pass. Earlier at UBS, set the engineering process and built the SDLC toolchain that the division's engineering teams worked inside. |
