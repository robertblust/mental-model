...
- Built its conformance half: source-code analysis across the estate, the mainframe included, producing EMF graphs held in the CDO model repository, and an automated metric for the technical coupling of software components and applications that identified interactions between subsystems not conforming to the architecture's specifications.
