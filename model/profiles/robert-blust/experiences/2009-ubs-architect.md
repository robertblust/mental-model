...
- Created the application architecture of the Integration Architecture tooling itself, built to reduce large numbers of point-to-point connections to an integration bus over defined concepts and open interface standards.
- Captured the division's actual communication patterns through source-code analysis, including the mainframe estate, and produced EMF-based graphs from them, held in the CDO model repository, that identified non-conformant interactions between subsystems.
- Architected and built an automated metric for the technical coupling of software components and applications, used to check that architectural specifications were being met — one of that tooling's features.
