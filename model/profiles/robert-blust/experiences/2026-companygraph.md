...
- Published the core as one shipped unit — nine schemas and sixteen numbered conventions that make the graph checkable — with a worked example company and an instance parser, and released it 17 times to v0.13.2, a manifest per release.
...
- Built the reference instance from it: this profile, 31 experiences, 69 skills on a four-level ladder and 5 values, every claim traced to an experience that shows it.
