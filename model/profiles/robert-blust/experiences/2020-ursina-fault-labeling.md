...
- Built the runtime on Google Kubernetes Engine from an empty project: cluster and ingress, certificate issuance and renewal, the deployment manifests, and the scripts that create the whole thing again rather than a console someone remembers clicking through.
