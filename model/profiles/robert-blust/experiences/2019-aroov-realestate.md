...
> 3AP · Backend & Integration Architect.
...
- Created the backend architecture — 3AP's microservice reference architecture in its event-driven form, on Google Cloud (Spring Boot, Kubernetes/GKE, Cloud Pub/Sub).
